...
public class App extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
     ...
     public void consoleInput(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        MainView.showResults(req, resp,  numbersListX.toString(), numbersListY.toString(),calcDatos.B0,calcDatos.B1,calcDatos.Rxy,calcDatos.R2,calcDatos.Yk,calcDatos.Dato1Exp2,calcDatos.Dato2Exp2);
       }catch(Exception ex){
         MainView.error(req, resp);
       }
    }
